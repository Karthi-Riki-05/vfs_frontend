  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 20 }}>
        ...
        <p style={{ color: '#6B7280', fontSize: 14, margin: 0 }}>Sign in to your account to continue</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ width: '100%', marginBottom: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
            ...
            <a href="/forgot-password" style={{ fontSize: 13, color: GREEN, fontWeight: 500, textDecoration: 'none' }}>
              Forgot password?
            </a>
          </div>
          <div style={{ position: 'relative', width: '100%' }}>
      ...
      <p style={{ textAlign: 'center', fontSize: 14, color: '#6B7280', marginTop: 20, marginBottom: 0 }}>
        ...
        <a href="/register" style={{ color: GREEN, fontWeight: 600, textDecoration: 'none' }}>Create account</a>
      </p>
