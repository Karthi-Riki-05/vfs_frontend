            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: 12, color: "#B45309" }}>
                  You&apos;re in an in-app browser. Google requires a real
                  browser (Chrome or Safari) to sign in. Open the link below in
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 4 }}>
              ...
              >
                <label style={{ ...mLabel, marginBottom: 0 }}>Password</label>
                <a
                  href="/forgot-password"
                  style={{
                    fontSize: 11,
