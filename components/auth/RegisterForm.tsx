  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 20 }}>
        <h1 style={{ fontSize: 22, fontWeight: 700, color: '#111827', margin: '0 0 4px' }}>Create your account</h1>
        <p style={{ color: '#6B7280', fontSize: 14, margin: 0 }}>Join Value Charts and start mapping your flows</p>
      </div>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 20, width: '100%' }}>
        ...
        {/* LinkedIn — blue, 44x44 */}
        <button type="button" onClick={() => signIn('linkedin', { callbackUrl: '/dashboard' })}
          style={{
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            height: 44, width: 44, minWidth: 44, borderRadius: 12, border: 'none',
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ width: '100%', marginBottom: 14 }}>
          ...
          <div style={{ position: 'relative', width: '100%' }}>
            ...
            <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder="John Doe" style={inputBase} onFocus={focusHandler} onBlur={blurHandler} />
          </div>
        </div>
        ...
        <div style={{ width: '100%', marginBottom: 14 }}>
          ...
          <div style={{ position: 'relative', width: '100%' }}>
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@example.com" style={inputBase} onFocus={focusHandler} onBlur={blurHandler} />
          </div>
        </div>
        ...
        {/* Terms */}
        <p style={{ fontSize: 12, color: '#9CA3AF', textAlign: 'center', lineHeight: 1.6, margin: '0 0 14px' }}>
          By signing up, you agree to our{' '}
          <a href="/terms" style={{ color: GREEN, textDecoration: 'none' }}>Terms of Service</a>
          {' '}and{' '}
          <a href="/privacy" style={{ color: GREEN, textDecoration: 'none' }}>Privacy Policy</a>
        </p>
